...
from game_agent import CustomPlayer, custom_score, custom_score_blanks, custom_score_generator, custom_score_blanks_agressive
...
def main():
    ...
    test_agents = [
        Agent(CustomPlayer(score_fn=custom_score_generator(3, custom_score_blanks_agressive), method='alphabeta', iterative=True, agressiveness=3), "Student custom blanks ag3"),
        Agent(CustomPlayer(score_fn=custom_score_generator(2), method='alphabeta', iterative=True, agressiveness=3), "Student custom_score ag2"),
        Agent(CustomPlayer(score_fn=custom_score_blanks, method='alphabeta', iterative=True, agressiveness=3), "Student custom blanks"),
        Agent(CustomPlayer(score_fn=custom_score_blanks_agressive, method='alphabeta', iterative=True, agressiveness=3), "Student custom blanks ag1"),
        Agent(CustomPlayer(score_fn=custom_score_generator(2, custom_score_blanks_agressive), method='alphabeta', iterative=True, agressiveness=3), "Student custom blanks ag2"),
    ]
